...
def create_app():
    with gr.Blocks(title="Qwen3-TTS", css=custom_css) as demo:
        ...
        with gr.Tab("Voice Cloning"):
                ...
                with gr.Column():
                    ...
                    def _role_panel(label, open_=True, name_ph="e.g. Alex"):
                        with gr.Accordion(label, open=open_):
                            with gr.Row():
                                rname = gr.Textbox(label="Role Name", placeholder=name_ph, value="", scale=3)
                        ...
                        return rname, rload, raudio, rtext, rtrans, rzip, rtxt, rclear

                    r1_name, r1_load, r1_audio, r1_text, r1_trans, r1_zip, r1_txt, r1_clear = \
                        _role_panel("Role 1 (Primary)", open_=True, name_ph="e.g. Alex")
                    r2_name, r2_load, r2_audio, r2_text, r2_trans, r2_zip, r2_txt, r2_clear = \
                        _role_panel("Role 2", open_=False, name_ph="e.g. Sara")
                    r3_name, r3_load, r3_audio, r3_text, r3_trans, r3_zip, r3_txt, r3_clear = \
            ...
            # Role callbacks
            for rname, rload, raudio, rtext, rtrans, rzip, rtxt, rclear in [
                (r1_name, r1_load, r1_audio, r1_text, r1_trans, r1_zip, r1_txt, r1_clear),
                (r2_name, r2_load, r2_audio, r2_text, r2_trans, r2_zip, r2_txt, r2_clear),
                (r3_name, r3_load, r3_audio, r3_text, r3_trans, r3_zip, r3_txt, r3_clear),
            ]:
                ...
                rclear.click(lambda: (None, None, ""), outputs=[rname, raudio, rtext])
                rload.upload(auto_name_from_file, inputs=[rload], outputs=[rname])
        ...
        with gr.Tab("Role Maker"):
            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    maker_status   = gr.Textbox(label="Status", value="Ready", interactive=False, lines=6)
